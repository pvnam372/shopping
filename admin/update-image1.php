...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$_SESSION['msg'] = "Ảnh sản phẩm cập nhật thành công !!";
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										?>
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Ảnh 1 hiện tại</label>
												<div class="controls">
											...
											<div class="control-group">
												<label class="control-label" for="basicinput">Ảnh 1 mới</label>
												<div class="controls">
