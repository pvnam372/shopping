...
if (strlen($_SESSION['alogin']) == 0) {
	...
	if (isset($_POST['submit'])) {
		...
		$sql = mysqli_query($con, "update  products set category='$category',subcategory='$subcategory',productName='$productname',productColor='$productcolor',productPrice='$productprice',productDescription='$productdescription',shippingCharge='$productscharge',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
		$_SESSION['msg'] = "Sản phẩm đã cập nhật thành công !!";
							...
							<div class="module">
								...
								<div class="module-body">
									...
									<form class="form-horizontal row-fluid" name="insertproduct" method="post" enctype="multipart/form-data">
										...
										$query = mysqli_query($con, "select products.*,category.categoryName as catname,category.id as cid,subcategory.subcategory as capacityname,subcategory.id as capacityid from products join category on category.id=products.category join subcategory on subcategory.id=products.subcategory where products.id='$pid'");
										$cnt = 1;
										...
										?>
											...
											<div class="control-group">
												...
												<div class="controls">
													<select name="subcategory" id="subcategory" class="span8 tip" >
														<option value="<?php echo htmlentities($row['capacityid']); ?>"><?php echo htmlentities($row['capacityname']); ?></option>
													</select>
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productColor" placeholder="Nhập màu sắc" value="<?php echo htmlentities($row['productColor']); ?>" class="span8 tip" >
												</div>
											</div>
											<div class="control-group">
												<label class="control-label" for="basicinput">Giá gốc sản phẩm</label>
												<div class="controls">
													<input type="text" name="productpricebd" placeholder="Nhập giá gốc sản phẩm" value="<?php echo htmlentities($row['productPriceBeforeDiscount']); ?>" class="span8 tip" >
												</div>
											</div>

											<div class="control-group">
												<label class="control-label" for="basicinput">Giá sau khuyến mãi sản phẩm</label>
												<div class="controls">
													<input type="text" name="productprice" placeholder="Nhập giá sản phẩm" value="<?php echo htmlentities($row['productPrice']); ?>" class="span8 tip" >
												</div>
											</div>
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productDescription" placeholder="Nhập số lượng sản phẩm" value="<?php echo htmlentities($row['productDescription']); ?>" class="span8 tip">
											...
											<div class="control-group">
												...
												<div class="controls">
													<input type="text" name="productShippingcharge" placeholder="Nhập phí vận chuyển" value="<?php echo htmlentities($row['shippingCharge']); ?>" class="span8 tip" >
												</div>
											</div>
