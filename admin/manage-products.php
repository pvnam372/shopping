										...
										<tbody>
											...
											?>
												<tr>
													...
													<td> <?php echo htmlentities($row['productcapacity']); ?></td>
													<td><?php echo htmlentities($row['productColor']); ?></td>
													<td><?php echo htmlentities($row['postingDate']); ?></td>
													<td>
														<a href="edit-products.php?id=<?php echo $row['id'] ?>"><i class="icon-edit"></i></a>
														<a href="manage-products.php?id=<?php echo $row['id'] ?>&del=delete" onClick="return confirm('Bạn có chắc chắn xóa?')"><i class="icon-remove-sign"></i></a>
													</td>
												</tr>
											<?php $cnt = $cnt + 1;
											} ?>
