						...
						<h2 style="margin:0">
							<div class="item">
								<a href="index.php" class="image">
									<img style="width:100%;" data-echo="brandsimage/logo.svg" src="assets/images/blank.gif" alt="">
								</a>
						</h2>
					</a>
				</div>
										...
										<div class="cart-item product-summary">
											<div class="row">
												...
												<div class="col-xs-7">
													...
													<div class="price"><?php echo ($row['productPrice'] + $row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?>Đ</div>
												</div>
