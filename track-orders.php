			...
			<div class="track-order-page inner-bottom-sm">
				<div class="row">
					<div class="col-md-12">
						...
						<span class="title-tag inner-top-vs">Vui lòng nhập ID đơn hàng của bạn vào ô bên dưới và nhấn Enter. ID này đã được cung cấp trên hóa đơn của bạn và trong email xác nhận mà bạn nên đã nhận được. </span>
						<form class="register-form outer-top-xs" role="form" method="post" action="order-details.php">
							<div class="form-group">
								<label class="info-title" for="exampleOrderId1">ID đơn hàng</label>
