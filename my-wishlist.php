...
?>
	...
	<head>
		...
		<title>Danh sách mong muốn</title>
			...
			<div class="container">
				<div class="breadcrumb-inner">
					<ul class="list-inline list-unstyled">
						...
						<li class='active'>Danh sách mong muốn</li>
					</ul>
						...
						<div class="col-md-12 my-wishlist">
							<div class="table-responsive">
								<table class="table">
									<thead>
										<tr>
											<th colspan="4">Danh sách mong muốn</th>
										</tr>
									</thead>
									<tbody>
										<?php
										...
										?>
												...
												<tr>
													...
													<td class="col-md-6">
														...
														<?php } ?>
														<div class="price">
															<?php echo htmlentities($row['pprice']); ?> đ
															<span>0đ</span>
														</div>
													</td>
													<td class="col-md-2">
											...
											<tr>
												<td style="font-size: 18px; font-weight:bold ">Danh sách trống</td>
