...
<head>
	...
	<title>Trà Nam Store | Đăng nhập | Đăng ký</title>
			...
			<div class="sign-in-page inner-bottom-sm">
				<div class="row">
					...
					<div class="col-md-6 col-sm-6 create-new-account">
						...
						<span class="checkout-subtitle outer-top-xs">Đăng ký hôm nay và bạn có thể: </span>
						<div class="checkbox">
							<label class="checkbox">
								Thực hiện thanh toán một cách nhanh chóng.
							</label>
							<label class="checkbox">
								Theo dõi đơn hàng của bạn một cách dễ dàng.
							</label>
							<label class="checkbox">
								Ghi nhớ những đơn hàng đã mua của bạn.
							</label>
						</div>
					</div>
					<!-- create a new account -->
