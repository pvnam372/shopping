...
if (isset($_GET['pid']) && $_GET['action'] == "wishlist") {
	if (strlen($_SESSION['login']) == 0) {
		...
		echo "<script>alert('Sản phẩm đã được thêm vào danh sách mong muốn');</script>";
						...
						<div class="sidebar-filter">
							...
							<div class="sidebar-widget wow fadeInUp outer-bottom-xs ">
								<div class="widget-header m-t-20">
									<h4 class="widget-title">Dòng máy</h4>
								</div>
						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active " id="grid-container">
								<div class="category-product  inner-top-vs">
									<div class="row">
										<?php
										$ret = mysqli_query($con, "select products.*, subcategory.subcategory as productName from products join subcategory on subcategory.id=products.subcategory where subcategory.subcategory like '$find'");
													...
													<div class="products">
														<div class="product">
															...
															<div class="product-info text-left">
																<h3 class="name"><a href="product-details.php?pid=<?php echo htmlentities($row['id']); ?>"><?php echo htmlentities($row['productName']); ?> <?php echo htmlentities($row['productcapacity']);?>GB <?php echo htmlentities($row['productColor']);?></a></h3>
																<div class="rating rateit-small"></div>
																<div class="description"></div>

																<div class="product-price">
																	<span class="price">
																		<?php echo htmlentities(number_format($row['productPrice'])); ?> </span>
