						...
						<div id="myTabContent" class="tab-content">
							<div class="tab-pane active " id="grid-container">
								<div class="category-product  inner-top-vs">
									<div class="row">
										<?php
										$ret = mysqli_query($con, "select products.*, subcategory.subcategory as productName from products join subcategory on subcategory.id=products.subcategory where category='$cid'");
